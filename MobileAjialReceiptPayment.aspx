<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileAjialReceiptPayment.aspx.cs" Inherits="WebUI.MobileAjialReceiptPayment" %>
...
<head id="Head1" runat="server">
    <title>Online Payment | Ajial Mutual Fund</title>
    ...
    <script src="MobileAjialReceiptPayment.js" type="text/javascript"></script>
</head>
<body>
    <form action="https://www.netcommercepay.com/iPAY/default.asp" method="post" id="Frm_ReceiptAjialNetCommerce" name="Frm_ReceiptAjialNetCommerce">
        <input type="hidden" id="payment_mode" name="payment_mode" value="test" />
