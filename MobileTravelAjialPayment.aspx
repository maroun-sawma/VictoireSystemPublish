<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileTravelAjialPayment.aspx.cs" Inherits="WebUI.MobileTravelAjialPayment" %>
...
<head id="Head1" runat="server">
    ...
    <script src="MobileTravelAjialPayment.js" type="text/javascript"></script>
</head>
<body>
    <form action="https://www.netcommercepay.com/iPAY/default.asp" method="post" id="Frm_TravelAjialNetCommerce" name="Frm_TravelAjialNetCommerce">
