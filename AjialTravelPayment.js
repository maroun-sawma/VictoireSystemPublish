...
function () {
    ...
    Btn_Pay_AjialTravelPolicy_Click();
}
);
/* --------------------------------------------------------------- */
...
function Service_Call_Completed(i_Response) {
    try {
        ...
        switch (_Service_Method) {
            case "Edit_MobileAjialTravelPaymentData":
                Edit_MobileAjialTravelPaymentData_Completed(i_Response);
                break;
        }
    }
    catch (e) {
...
/* --------------------------------------------------------------- */
function Btn_Pay_AjialTravelPolicy_Click() {
    try {
        /* ------------------------------------- */
        //debugger;
        ...
        //alert(_Params);    
        _Service_Method = "Edit_MobileAjialTravelPaymentData";
        _Async = true;
        CallService();
        /* ---------------- */
    }
    catch (e) {
        alert("Btn_Pay_AjialTravelPolicy_Click : " + e.message);
    }
}
/* --------------------------------------------------------------- */

function Edit_MobileAjialTravelPaymentData_Completed(i_Response) {
    try {
        //debugger;
        ...
        alert("Edit_MobileAjialTravelPaymentData_Completed: " + e.message);
    }
}
